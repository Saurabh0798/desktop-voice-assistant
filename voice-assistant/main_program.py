...
data_path= 'C:/Users/Asus/Desktop/AI project/face_sample/'
...
print('model trainning Successfull!!!')
...
while True:
     ...
     try:
         ...
         if confidence > 85:
             cv2.putText(image,'Unlocked',(250,450), cv2.FONT_HERSHEY_COMPLEX,1,(0,255,255),2)
